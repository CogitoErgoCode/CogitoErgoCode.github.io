...
- `Financial:` In economic or game theory, a [zero-sum game](https://en.wikipedia.org/wiki/Zero-sum_game) is an instance where for every winner there is a loser or group of losers. If you subtract the losses from all the gains you end up with zero. In order to increase the likelihood of long-term monetary success, it would be beneficial to avoid speculation except for small percentages of capital. **Zero-sum does not mean that you will not make money, it means you're more likey to lose money.** Non-speculative investments exist, and once in a life time opportunities happen every year. 
